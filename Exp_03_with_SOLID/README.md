...
در آزمایش ۳ و ۴، با اعمال اصول SOLID به موارد نقض شناسایی شده پرداختیم و تغییرات لازم را در کد اعمال کردیم. این تغییرات شامل موارد زیر بودند:
- **تفکیک اینترفیس‌ها**: با ایجاد اینترفیس‌های جداگانه برای هر نوع سرویس، کلاس‌های پیاده‌سازی تنها متدهای مربوط به خود را پیاده‌سازی کردند. این کار باعث کاهش پیچیدگی و افزایش خوانایی کد شد.
- **استفاده از الگوی طراحی Factory**: برای انتخاب و ایجاد سرویس‌های مختلف، از الگوی طراحی Factory استفاده کردیم که امکان افزودن سرویس‌های جدید بدون تغییر در کدهای موجود را فراهم می‌کند.
- **حذف متدهای غیرضروری**: با حذف متدهای غیرضروری و جایگزینی آن‌ها با متدهای مرتبط، کلاس‌ها تنها مسئولیت‌های مربوط به خود را بر عهده گرفتند.

### مزایای به‌کارگیری صحیح اصول SOLID
1. **قابلیت نگهداری بهتر**: با تفکیک مسئولیت‌ها و کاهش وابستگی‌های غیرضروری، کدها ساده‌تر و قابل فهم‌تر شده‌اند و اعمال تغییرات در آینده آسان‌تر خواهد بود.
2. **قابلیت توسعه‌ی بیشتر**: با استفاده از اصول OCP و DIP، امکان افزودن ویژگی‌ها و سرویس‌های جدید بدون تغییر در کدهای موجود فراهم شده است. این امر باعث افزایش انعطاف‌پذیری برنامه می‌شود.
3. **کاهش خطاهای بالقوه**: با رعایت اصول LSP و ISP، کدها به صورت صحیح‌تری پیاده‌سازی شده و احتمال بروز خطاهای ناشی از متدهای غیرمرتبط یا خالی کاهش یافته است.
4. **افزایش خوانایی و قابل فهم بودن کد**: با استفاده از اصول SOLID، کدها ساختارمندتر و منظم‌تر شده‌اند و درک و بررسی آن‌ها برای توسعه‌دهندگان آسان‌تر خواهد بود.

### نتیجه‌گیری نهایی
به‌کارگیری صحیح اصول SOLID در طراحی و پیاده‌سازی برنامه‌ها، علاوه بر افزایش قابلیت نگهداری و توسعه‌ی کدها، به کاهش خطاهای بالقوه و افزایش خوانایی و قابل فهم بودن کدها کمک می‌کند. این اصول به توسعه‌دهندگان امکان می‌دهد تا برنامه‌هایی انعطاف‌پذیر، پایدار و قابل توسعه ایجاد کنند که به راحتی می‌توانند با تغییرات و نیازهای جدید سازگار شوند. 
